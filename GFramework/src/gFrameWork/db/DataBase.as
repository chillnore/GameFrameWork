...
package gFrameWork.db
{
	public class DataBase
	{
		 ...
		 * 
		 */		
		public static function installTable(tbName:String,tb:Class,tbFormat:Class,profileDB:XML):void
		{
			instance.installTable(tbName,tb,tbFormat,profileDB);	
		}
...
class dataBase
{
	 ...
	 * 
	 */
	public function installTable(tbName:String,tb:Class,tbFormat:Class,profileDB:XML):void
	{
		if(!mDB[tbName])
		{
			//获取一级目录下的所有数据项的子级
